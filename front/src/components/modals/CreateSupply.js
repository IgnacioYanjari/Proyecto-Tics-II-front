...
class CreateSupply extends Component {
  ...
  handleSubmit(event){
    ...
    this.productService.createSupply({
      name: name,
      price: price,
      brand: brand,
      typeId: type.id,
  ...
  render() {
    ...
    return(
      <div>
        <button type="button" id="modalButton" className="btn btn-primary" data-toggle="modal" data-target="#modalSupply">
          Crear
        </button>

        <div className="modal fade" id="modalSupply" tabIndex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalCenterTitle">Crear Insumo</h5>
