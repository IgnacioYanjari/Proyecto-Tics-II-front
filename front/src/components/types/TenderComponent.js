...
import CreateTenderType from "components/modals/create/TenderType";
  ...
  save(form, key) {
    form.validateFields(async (error, row) => {
      ...
      if (index > -1) {
        ...
        let res = await this.typeService.updateTender({name}, id);
...
class TenderComponent extends Component {
  ...
  loadTenders() {
    this.typeService.getTenders().then(res => {
      if (res.status === "success") {
      ...
      <div className="table-responsive">
        {tendersLen !== 0 ? (
          <div>
            ...
            <CreateTenderType refreshTable={this.loadTenders} />
