...
import CreateMaterialType from "components/modals/create/MaterialType";
  ...
  save(form, key) {
    form.validateFields(async (error, row) => {
      ...
      if (index > -1) {
        ...
        let res = await this.typeService.updateMaterial({name}, id);
      ...
      <div className="table-responsive">
        {materialsLen !== 0 ? (
          <div>
            ...
            <CreateMaterialType refreshTable={this.loadMaterials} />
            <EditableTable
